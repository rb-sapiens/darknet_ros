...
: nodeHandle_(nh), imageTransport_(nodeHandle_), numClasses_(0), classLabels_(0), rosBoxes_(0),
  rosBoxCounter_(0)
{
...
bool YoloObjectDetector::readParameters()
{
  ...
  // Set vector sizes.
  nodeHandle_.param(
    "yolo_model/detection_classes/names", classLabels_,
...
void YoloObjectDetector::init()
{
  ...
  nodeHandle_.param(
    "yolo_model/weight_file/name", weightsModel,
  ...
  nodeHandle_.param(
    "subscribers/camera_reading/topic", cameraTopicName,
  ...
  nodeHandle_.param(
    "publishers/bounding_boxes/topic", boundingBoxesTopicName,
    std::string("bounding_boxes"));
  nodeHandle_.param("publishers/bounding_boxes/queue_size", boundingBoxesQueueSize, 1);
  nodeHandle_.param("publishers/bounding_boxes/latch", boundingBoxesLatch, false);
  nodeHandle_.param(
    "publishers/detection_image/topic", detectionImageTopicName,
  ...
  objectPublisher_ =
    nodeHandle_.advertise<darknet_ros_msgs::ObjectCount>(
    objectDetectorTopicName,
  ...
  detectionImagePublisher_ =
    nodeHandle_.advertise<sensor_msgs::Image>(
...
detection * YoloObjectDetector::avgPredictions(network * net, int * nboxes)
{
  ...
  detection * dets = get_network_boxes(
    net, buff_[0].w, buff_[0].h, demoThresh_, demoHier_, 0, 1,
    nboxes);
  return dets;
}
...
void YoloObjectDetector::setupNetwork(
  char * cfgfile, char * weightfile, char * datafile, float thresh, char ** names, int classes,
  int delay,
